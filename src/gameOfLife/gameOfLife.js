...
const livingNeighbours = (cell, liveCells) =>
  liveCells.filter((liveCell) => {
    ...
    return (
      isDifferentCell(
        ...
        yOfLiveCell,
        yOfCurrentCell,
      ) && isNeighbour(xOfLiveCell, xOfCurrentCell, yOfLiveCell, yOfCurrentCell)
    );
  });

const isDifferentCell = (x1, x2, y1, y2) => x1 !== x2 || y1 !== y2;
const isNeighbour = (x1, x2, y1, y2) =>
