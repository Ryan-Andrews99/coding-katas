import { calculateDistance, calculateRaces, returnAnswerPart1, returnAnswerPart2 } from './index'
...
describe('returnAnswerPart1', () => {
    it('passes the test data', () => {
        expect(returnAnswerPart1(`Time:      7  15   30
...
describe('returnAnswerPart2', () => {
    it('passes the test data', () => {
        expect(returnAnswerPart2(`Time:      7  15   30
